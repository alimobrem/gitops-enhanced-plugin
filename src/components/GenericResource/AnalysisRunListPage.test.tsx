...
import { AnalysisRunListPage } from './AnalysisRunListPage';

describe('AnalysisRunListPage', () => {
  it('renders without crashing', () => {
    render(<AnalysisRunListPage />);
  });

  it('renders the page title', () => {
    render(<AnalysisRunListPage />);
    expect(screen.getByRole('heading', { name: 'AnalysisRuns' })).toBeInTheDocument();
  });
});
