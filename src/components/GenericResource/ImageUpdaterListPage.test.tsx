...
import { ImageUpdaterListPage } from './ImageUpdaterListPage';

describe('ImageUpdaterListPage', () => {
  it('renders without crashing', () => {
    render(<ImageUpdaterListPage />);
  });

  it('renders the page title', () => {
    render(<ImageUpdaterListPage />);
    expect(screen.getByRole('heading', { name: 'ImageUpdaters' })).toBeInTheDocument();
  });
});
