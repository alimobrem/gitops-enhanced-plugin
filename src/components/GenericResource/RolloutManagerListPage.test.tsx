...
import { RolloutManagerListPage } from './RolloutManagerListPage';

describe('RolloutManagerListPage', () => {
  it('renders without crashing', () => {
    render(<RolloutManagerListPage />);
  });

  it('renders the page title', () => {
    render(<RolloutManagerListPage />);
    expect(screen.getByRole('heading', { name: 'RolloutManagers' })).toBeInTheDocument();
  });
});
