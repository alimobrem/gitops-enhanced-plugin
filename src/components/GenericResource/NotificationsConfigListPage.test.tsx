...
import { NotificationsConfigListPage } from './NotificationsConfigListPage';

describe('NotificationsConfigListPage', () => {
  it('renders without crashing', () => {
    render(<NotificationsConfigListPage />);
  });

  it('renders the page title', () => {
    render(<NotificationsConfigListPage />);
    expect(screen.getByRole('heading', { name: 'Notifications Configurations' })).toBeInTheDocument();
  });
});
