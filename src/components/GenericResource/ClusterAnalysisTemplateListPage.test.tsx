...
import { ClusterAnalysisTemplateListPage } from './ClusterAnalysisTemplateListPage';

describe('ClusterAnalysisTemplateListPage', () => {
  it('renders without crashing', () => {
    render(<ClusterAnalysisTemplateListPage />);
  });

  it('renders the page title', () => {
    render(<ClusterAnalysisTemplateListPage />);
    expect(screen.getByRole('heading', { name: 'ClusterAnalysisTemplates' })).toBeInTheDocument();
  });
});
