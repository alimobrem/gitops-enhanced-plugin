...
import { NamespaceManagementListPage } from './NamespaceManagementListPage';

describe('NamespaceManagementListPage', () => {
  it('renders without crashing', () => {
    render(<NamespaceManagementListPage />);
  });

  it('renders the page title', () => {
    render(<NamespaceManagementListPage />);
    expect(screen.getByRole('heading', { name: 'NamespaceManagements' })).toBeInTheDocument();
  });
});
